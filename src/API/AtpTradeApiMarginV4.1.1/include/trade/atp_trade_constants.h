// code_generator_tag
// constants:b6a9ff894099b50e15889de352b5f2fd types:cc118dbe2164f5c249ea9b36e21a39de template:e3fd0e61c5b8727361552db76c1636b8 code:4d77cb56f9765adfb411b31428622ab3
...
struct TRADE_API ATPRejectReasonCodeConst
{
	...
	static const ATPRejectReasonCodeType kClientVersionStringError = 220;	///<客户端版本串校验不通过
	static const ATPRejectReasonCodeType kCustIDIsNotExist = 221;	///<客户号未设置客户端版本串
	static const ATPRejectReasonCodeType kClientVersionStringIsEmpty = 222;	///<客户端版本串不能为空
	...
	static const ATPRejectReasonCodeType kAccountConsistencyVerifyFailed = 242;	///<账户一致性校验失败
	static const ATPRejectReasonCodeType kGwUserFunctionNoCheckFailed = 243;	///<网关用户级功能号禁止
	static const ATPRejectReasonCodeType kAccessTerminalCheckFaild = 244;	///<接入终端管控不通过
	static const ATPRejectReasonCodeType kCustIdForbidInGwUser = 245;	///<当前网关用户不允许使用此交易账号
	static const ATPRejectReasonCodeType KCustomerPasswordVerificationFailed = 246;	///<客户密码验证失败
	static const ATPRejectReasonCodeType KGwUserOriginalPasswordError = 247;	///<网关用户原密码错误
	static const ATPRejectReasonCodeType KGwUserNewPasswordStrengthNotRequirements = 248;	///<网关用户新密码不符合强度要求
	static const ATPRejectReasonCodeType KGwUserNotBindCustID = 249;	///<非绑定客户,禁止修改网关用户密码
	static const ATPRejectReasonCodeType KGwUserPasswordModifyFailed = 250;	///<网关用户密码修改失败
	static const ATPRejectReasonCodeType kDateFormatCheckFailed = 251;	///<日期格式检查不通过
	static const ATPRejectReasonCodeType kOrderWayCheckFailed = 252;	///<委托方式管控不通过
	static const ATPRejectReasonCodeType kNotSupportSuchInterfaceCalls = 254;	///<当前子产品不支持此类接口调用
	static const ATPRejectReasonCodeType kServerConnectionFailure = 255;	///<服务器连接失败
	static const ATPRejectReasonCodeType kRequestTimeout = 256;	///<请求超时
	static const ATPRejectReasonCodeType kQueryRepaymentDetailRequestError = 257;	///<请求头参数不正确或签名信息错误
	static const ATPRejectReasonCodeType kQueryRepaymentDetailFundIDOrBranchIDNotExist = 258;	///<资金账户或营业部不存在
	static const ATPRejectReasonCodeType kQueryRepaymentDetailReturnNumberError = 259;	///<查询返回数量不能小于0
	static const ATPRejectReasonCodeType kQueryRepaymentDetailQueryIndexError = 260;	///<起始索引号不能小于0
	static const ATPRejectReasonCodeType kQueryRepaymentDetailCannotFoundCustinfo = 261;	///<资金账户和营业部查不到客户信息
	static const ATPRejectReasonCodeType kQueryRepaymentDetailInvalidArgument = 263;	///<请求参数非法
	...
	static const ATPRejectReasonCodeType kNetShortGageConcentrationRatioExceedLimit = 1259;	///<空头证券集中度超限
	static const ATPRejectReasonCodeType kNetLongGageConcentrationRatioExceedLimit = 1260;	///<多头证券集中度超限
	static const ATPRejectReasonCodeType kRzAvailableQuotaNotEnough = 1261;	///<融资可用额度不足
	static const ATPRejectReasonCodeType kCorpRiskGageConcentrationRateLimit = 1262;	///<公司级风控担保品集中度触警
	static const ATPRejectReasonCodeType kMarketPriceRangeOut = 1263;	///<市价委托的保护价在价格范围之外
	static const ATPRejectReasonCodeType kFundAccountIDNotExist = 1264;	///<资金帐户信息不存在
	static const ATPRejectReasonCodeType kCorpRiskGageConcentrationRateOverLimit = 1265;	///<公司风控担保品规模预警超限
...
struct TRADE_API ATPShareNegotiabilityConst
{
	...
	static const ATPShareNegotiabilityType RestrictedStock;	///<沪深：首发后限售股；北京：挂牌/上市后个人类限售股
	static const ATPShareNegotiabilityType IncentiveStock;	///<股权激励限售股
	static const ATPShareNegotiabilityType InstitutionStock;	///<挂牌/上市后机构类限售股
	static const ATPShareNegotiabilityType ExecutiveLockStock;	///<高管锁定股
	static const ATPShareNegotiabilityType PreHumanStock;	///<挂牌/上市前个人类限售股
	static const ATPShareNegotiabilityType PreInstitutionStock;	///<挂牌/上市前机构类限售股
	...
	static const ATPShareNegotiabilityType InitiatorDomesticStock;	///<发起人境内法人股
	static const ATPShareNegotiabilityType InitiatorForeignStock;	///<发起人外资法人股
	static const ATPShareNegotiabilityType InitiatorNaturalStock;	///<发起人自然人股
	static const ATPShareNegotiabilityType OtherInitiatorStock;	///<其他发起人股
	static const ATPShareNegotiabilityType OrientationStateStock;	///<定向法人国家股
	static const ATPShareNegotiabilityType OrientationSLS;	///<定向法人国有法人股
	static const ATPShareNegotiabilityType OrientationDomesticStock;	///<定向法人境内法人股
	static const ATPShareNegotiabilityType OrientationForeignStock;	///<定向法人外资法人股
	static const ATPShareNegotiabilityType OrientationNaturalStock;	///<定向法人自然人股
	static const ATPShareNegotiabilityType OtherOrientationStock;	///<其他定向法人股
	static const ATPShareNegotiabilityType InternalStaffStock;	///<内部职工股
	static const ATPShareNegotiabilityType ExecutiveStock;	///<高管股
	static const ATPShareNegotiabilityType CirculationUnconfirmedStock;	///<流通股待确认股份
	static const ATPShareNegotiabilityType RestrictedUnconfirmedStock;	///<限售股待确认股份
...
struct TRADE_API ATPLiabilityDetailConst
{
	...
	static const ATPLiabilityDetailType kShareLiabilityChange = 4;	///<股份负债变更
	static const ATPLiabilityDetailType kCapitalLiabilityChange = 5;	///<资金负债变更
	static const ATPLiabilityDetailType kRZBuyUnTradeAmountChange = 6;	///<融资买入未成交金额变更
	static const ATPLiabilityDetailType kRQSellUnTradeAmountChange = 7;	///<融券卖出未成交金额变更
	static const ATPLiabilityDetailType kSettleUnpayInterestChange = 9;	///<已结未付利息金额变更
	static const ATPLiabilityDetailType kSettleUnpayPenaltyChange = 10;	///<已结未付罚息金额变更
	static const ATPLiabilityDetailType kExtraSecurityChange = 11;	///<余券股份变更
	static const ATPLiabilityDetailType kFundLiabilityTempChange = 12;	///<资金负债临时调整
	static const ATPLiabilityDetailType kShareLiabilityTempChange = 13;	///<股份负债临时调整

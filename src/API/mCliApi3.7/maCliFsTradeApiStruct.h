...
//-------------------------------10308011:机构信息查询--------------------------
struct MATRADEAPI CReqFsQry10308011Field
{
  int             iIntOrg;                    // 内部机构 
...
struct MATRADEAPI CRspFsQry10308011Field
{
...
//-------------------------------10308013:证券信息查询--------------------------
struct MATRADEAPI CReqFsQry10308013Field
{
...
struct MATRADEAPI CRspFsQry10308013Field
{
  char            szQryPos[32 + 1];           // 定位串 
...
//-------------------------------10308012:字典信息查询--------------------------
struct MATRADEAPI CReqFsQry10308012Field
{
  char            szDdId[32 + 1];             // 字典标识 
  char            szDdItem[32 + 1];           // 字典项目 
};

struct MATRADEAPI CRspFsQry10308012Field
{
...
//-------------------------------10308014:系统状态查询--------------------------
struct MATRADEAPI CReqFsQry10308014Field
{
};

struct MATRADEAPI CRspFsQry10308014Field
{
  int             iTrdDate;                   // 交易日期 
  int             iSettDate;                  // 交收日期 
...
//-------------------------------10510605:银证转账--------------------------
struct MATRADEAPI CReqFs10510605Field
{
  char            chCurrency;                 // 货币代码 字典[CURRENCY]
...
struct MATRADEAPI CRspFs10510605Field
{
  char            szSerialNo[64 + 1];         // 流水序号 
};

//-------------------------------10510606:券商发起查银行余额--------------------------
struct MATRADEAPI CReqFsQry10510606Field
{
  LONGLONG        llCuacctCode;               // 资金账户 
  char            chCurrency;                 // 货币代码 字典[CURRENCY]
  int             iExtOrg;                    // 外部机构 
...
struct MATRADEAPI CRspFsQry10510606Field
{
  char            szSerialNo[64 + 1];         // 流水序号 
};

//-------------------------------10510608:查询银证业务流水--------------------------
struct MATRADEAPI CReqFsQry10510608Field
{
  int             iOccurDate;                 // 发生日期 
...
struct MATRADEAPI CRspFsQry10510608Field
{
  LONGLONG        llSerialNo;                 // 流水序号 
  int             iOccurDate;                 // 发生日期 
...
//-------------------------------10510620:客户内现金划转--------------------------
struct MATRADEAPI CReqFs10510620Field
{
  int             iIntOrg;                    // 机构代码 
...
struct MATRADEAPI CRspFs10510620Field
{
...
//-------------------------------10510621:账户资金归集--------------------------
struct MATRADEAPI CReqFsQry10510621Field
{
  int             iOrgid;                     // 机构代码 
  LONGLONG        llCuacctCode;               // 资金账户 
  char            chCurrency;                 // 货币代码 字典[CURRENCY]
...
struct MATRADEAPI CRspFsQry10510621Field
{
...
//-------------------------------10510601:查询转帐银行帐户--------------------------
struct MATRADEAPI CReqFsQry10510601Field
{
...
struct MATRADEAPI CRspFsQry10510601Field
{
  LONGLONG        llCustCode;                 // 客户代码 
  int             iIntOrg;                    // 机构编码 
  int             iExtOrg;                    // 银行代码 
...
//-------------------------------10510468:财富账户资金划拨--------------------------
struct MATRADEAPI CReqFsQry10510468Field
{
  LONGLONG        llCuacctCode;               // 资金账户 
...
struct MATRADEAPI CRspFsQry10510468Field
{
  int             iOutSno;                    // 转出流水号 
  int             iInSno;                     // 转入流水号 
};
...
//-------------------------------10510473:财富账户划拨流水查询--------------------------
struct MATRADEAPI CReqFsQry10510473Field
{
  int             iBeginDate;                 // 开始日期 
  int             iEndDate;                   // 结束日期 
  LONGLONG        llCuacctCode;               // 资金账户 
...
struct MATRADEAPI CRspFsQry10510473Field
{
...
//-------------------------------10301105:客户登录--------------------------
struct MATRADEAPI CReqFsQry10301105Field
{
...
struct MATRADEAPI CRspFsQry10301105Field
{
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            chStkex;                    // 交易市场 字典[STKEX]
...
//-------------------------------10308112:资产账户查询--------------------------
struct MATRADEAPI CReqFsQry10308112Field
{
  LONGLONG        llUserCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
};

struct MATRADEAPI CRspFsQry10308112Field
{
...
//-------------------------------10308113:财富账户查询--------------------------
struct MATRADEAPI CReqFsQry10308113Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
};

struct MATRADEAPI CRspFsQry10308113Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
//-------------------------------10308001:股东查询--------------------------
struct MATRADEAPI CReqFsQry10308001Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
...
struct MATRADEAPI CRspFsQry10308001Field
{
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            chStkex;                    // 交易市场 字典[STKEX]
...
//-------------------------------10308010:股东交易协议查询--------------------------
struct MATRADEAPI CReqFsQry10308010Field
{
  LONGLONG        llCustCode;                 // 客户代码 
};

struct MATRADEAPI CRspFsQry10308010Field
{
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
...
//-------------------------------10308611:适当性匹配检查--------------------------
struct MATRADEAPI CReqFs10308611Field
{
...
struct MATRADEAPI CRspFs10308611Field
{
...
//-------------------------------10308068:客户适当性查询--------------------------
struct MATRADEAPI CReqFsQry10308068Field
{
  LONGLONG        llCuacctCode;               // 资产账号 
};

struct MATRADEAPI CRspFsQry10308068Field
{
  LONGLONG        llCustCode;                 // 客户代码 
...
//-------------------------------10308069:产品适当性查询--------------------------
struct MATRADEAPI CReqFsQry10308069Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
  int             iStkBiz;                    // 证券业务 字典[STK_BIZ]
...
struct MATRADEAPI CRspFsQry10308069Field
{
...
//-------------------------------10308048:资金查询--------------------------
struct MATRADEAPI CReqFsQry10308048Field
{
...
struct MATRADEAPI CRspFsQry10308048Field
{
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
//-------------------------------10308002:总资产查询--------------------------
struct MATRADEAPI CReqFsQry10308002Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            chCurrency;                 // 货币代码 字典[CURRENCY]
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CRspFsQry10308002Field
{
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            chCurrency;                 // 货币代码 字典[CURRENCY]
...
//-------------------------------10308003:股份资产查询--------------------------
struct MATRADEAPI CReqFsQry10308003Field
{
  LONGLONG        llCuacctCode;               // 资产账户 资产账户和客户代码不能同时为空
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CRspFsQry10308003Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            szStkpbu[8 + 1];            // 交易单元 
  LONGLONG        llCustCode;                 // 客户代码 
...
//-------------------------------10308004:当日委托查询--------------------------
struct MATRADEAPI CReqFsQry10308004Field
{
  LONGLONG        llCuacctCode;               // 资产账户 资产账户和客户代码不能同时为空
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFsQry10308004Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
  int             iOrderDate;                 // 委托日期 
...
//-------------------------------10308006:当日成交查询--------------------------
struct MATRADEAPI CReqFsQry10308006Field
{
  LONGLONG        llCuacctCode;               // 资产账户 资产账户和客户代码不能同时为空
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CRspFsQry10308006Field
{
  char            szQryPos[32 + 1];           // 定位串 
...
//-------------------------------10308053:当日成交统计--------------------------
struct MATRADEAPI CReqFsQry10308053Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkCode[8 + 1];           // 证券代码 
...
struct MATRADEAPI CRspFsQry10308053Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
  LONGLONG        llCuacctCode;               // 资产账户 
...
//-------------------------------10308056:最大可交易数量计算--------------------------
struct MATRADEAPI CReqFsQry10308056Field
{
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CRspFsQry10308056Field
{
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szTrdacct[20 + 1];          // 证券账户 
...
//-------------------------------10308601:证券交易买卖委托申报--------------------------
struct MATRADEAPI CReqFs10308601Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szTrdacct[20 + 1];          // 证券账户 
...
struct MATRADEAPI CRspFs10308601Field
{
  int             iOrderBsn;                  // 委托批号 
  char            szOrderId[10 + 1];          // 合同序号 
  LONGLONG        llCuacctCode;               // 资产账户 
...
//-------------------------------10308607:证券交易委托撤单--------------------------
struct MATRADEAPI CReqFs10308607Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFs10308607Field
{
  int             iOrderBsn;                  // 委托批号 
  char            szOrderId[10 + 1];          // 合同序号 
  LONGLONG        llCuacctCode;               // 资产账户 
...
//-------------------------------10308054:可撤单委托查询--------------------------
struct MATRADEAPI CReqFsQry10308054Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[32 + 1];            // 交易板块 支持多选，格式：值1，值2，值3；例如：00,01,03,10,11
...
struct MATRADEAPI CRspFsQry10308054Field
{
...
//-------------------------------10308606:证券交易批量撤单--------------------------
struct MATRADEAPI CReqFs10308606Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFs10308606Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
//-------------------------------10308602:重置成本--------------------------
struct MATRADEAPI CReqFs10308602Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
...
struct MATRADEAPI CRspFs10308602Field
{
...
struct MATRADEAPI CReqFsQry10308015Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkCode[8 + 1];           // 证券代码 
...
struct MATRADEAPI CRspFsQry10308015Field
{
  char            szQryPos[32 + 1];           // 定位串 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CReqFsQry10308016Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkCode[8 + 1];           // 证券代码 
...
struct MATRADEAPI CRspFsQry10308016Field
{
  char            szQryPos[32 + 1];           // 定位串 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CReqFsQry10308017Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308017Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
//-------------------------------10418004:新股配号查询--------------------------
struct MATRADEAPI CReqFsQry10418004Field
{
...
struct MATRADEAPI CRspFsQry10418004Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iSettDate;                  // 清算日期 
  LONGLONG        llSerialNo;                 // 流水序号 
...
//-------------------------------10418005:新股中签查询--------------------------
struct MATRADEAPI CReqFsQry10418005Field
{
  LONGLONG        llCuacctCode;               // 资金账号 资金账户及证券账户不能同时为空
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szTrdacct[20 + 1];          // 证券账户 资金账户及证券账户不能同时为空
...
struct MATRADEAPI CRspFsQry10418005Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
...
//-------------------------------10418006:新股申购市值额度查询--------------------------
struct MATRADEAPI CReqFsQry10418006Field
{
...
struct MATRADEAPI CRspFsQry10418006Field
{
  char            szQryPos[32 + 1];           // 定位串 
  LONGLONG        llCustCode;                 // 客户代码 
  int             iIntOrg;                    // 机构编码 
...
//-------------------------------10418007:新股信息查询--------------------------
struct MATRADEAPI CReqFsQry10418007Field
{
  char            chStkCls;                   // 证券类别 字典[STK_CLS]
};

struct MATRADEAPI CRspFsQry10418007Field
{
  char            szStkCode[8 + 1];           // 证券代码 
  char            szStkName[16 + 1];          // 证券名称 
...
//-------------------------------10308019:报价回购品种信息查询--------------------------
struct MATRADEAPI CReqFsQry10308019Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
  char            szProdcode[12 + 1];         // 产品编码 
...
struct MATRADEAPI CRspFsQry10308019Field
{
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CReqFsQry10308020Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308020Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
//-------------------------------10308021:报价回购质押物查询--------------------------
struct MATRADEAPI CReqFsQry10308021Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CRspFsQry10308021Field
{
  char            szQryPos[32 + 1];           // 定位串 
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
...
//-------------------------------10308608:报价回购合约展期--------------------------
struct MATRADEAPI CReqFs10308608Field
{
  int             iTrdDate;                   // 交易日期 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  LONGLONG        llCuacctCode;               // 资产账户 
...
struct MATRADEAPI CRspFs10308608Field
{
};

//-------------------------------10308022:报价回购质押资金查询--------------------------
struct MATRADEAPI CReqFsQry10308022Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szTrdacct[20 + 1];          // 股东代码 
...
struct MATRADEAPI CRspFsQry10308022Field
{
  char            szQryPos[32 + 1];           // 定位串 
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
...
//-------------------------------10308023:报价回购预约流水查询--------------------------
struct MATRADEAPI CReqFsQry10308023Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CRspFsQry10308023Field
{
  char            chStkex;                    // 证券交易所 字典[STKEX]
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
...
//-------------------------------10308610:报价回购预约--------------------------
struct MATRADEAPI CReqFs10308610Field
{
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CRspFs10308610Field
{
};

//-------------------------------10308024:报价回购可提前购回合约查询--------------------------
struct MATRADEAPI CReqFsQry10308024Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308024Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iRepchDate;                 // 到期日期 
  int             iTrdDate;                   // 交易日期 
...
struct MATRADEAPI CReqFsQry10308025Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308025Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iRepchDate;                 // 到期日期 
  int             iTrdDate;                   // 交易日期 
...
struct MATRADEAPI CReqFsQry10308026Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            chStkex;                    // 交易市场 字典[STKEX]
...
struct MATRADEAPI CRspFsQry10308026Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iRepchDate;                 // 到期日期 
  int             iTrdDate;                   // 交易日期 
...
struct MATRADEAPI CReqFsQry10308027Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            chPreBookType;              // 预约类型 字典[PRE_BOOK_TYPE]
...
struct MATRADEAPI CRspFsQry10308027Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iRepchDate;                 // 到期日期 
  int             iTrdDate;                   // 交易日期 
...
struct MATRADEAPI CReqFsQry10308028Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            chPreBookType;              // 预约类型 字典[PRE_BOOK_TYPE]
...
struct MATRADEAPI CRspFsQry10308028Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  LONGLONG        llCustCode;                 // 客户代码 
...
struct MATRADEAPI CReqFsQry10308029Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308029Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iRepchDate;                 // 到期日期 
  int             iTrdDate;                   // 交易日期 
...
struct MATRADEAPI CReqFsQry10308074Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szQryPos[32 + 1];           // 定位串 
...
struct MATRADEAPI CRspFsQry10308074Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iRepchDate;                 // 到期日期 
  int             iTrdDate;                   // 交易日期 
...
//-------------------------------10308615:融资行权直接还款--------------------------
struct MATRADEAPI CReqFs10308615Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            chCurrency;                 // 货币代码 字典[CURRENCY]
...
struct MATRADEAPI CRspFs10308615Field
{
  char            szRealRepayAmt[21 + 1];     // 实际还款金额 
};

//-------------------------------10308030:融资行权合约查询--------------------------
struct MATRADEAPI CReqFsQry10308030Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFsQry10308030Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
...
//-------------------------------10308085:融资行权可还负债查询--------------------------
struct MATRADEAPI CReqFsQry10308085Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            chCurrency;                 // 货币代码 字典[CURRENCY]
...
struct MATRADEAPI CRspFsQry10308085Field
{
...
//-------------------------------10308087:融资行权偿还明细查询--------------------------
struct MATRADEAPI CReqFsQry10308087Field
{
  int             iTrdDate;                   // 交易日期 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CRspFsQry10308087Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
  char            szContractSno[32 + 1];      // 合约编号 
...
struct MATRADEAPI CReqFsQry10308031Field
{
  char            chStkex;                    // 证券交易所 字典[STKEX]
...
struct MATRADEAPI CRspFsQry10308031Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szCompanyCode[8 + 1];       // 公司代码 
...
//-------------------------------10308032:网络投票投票结果查询--------------------------
struct MATRADEAPI CReqFsQry10308032Field
{
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szTrdacct[20 + 1];          // 交易账户 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308032Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iVoteDate;                  // 投票日期 
  LONGLONG        llCustCode;                 // 客户代码 
...
//-------------------------------10308033:网络投票议案信息查询--------------------------
struct MATRADEAPI CReqFsQry10308033Field
{
  char            szMeetingSeq[10 + 1];       // 股东大会编码 
  char            szVoteId[10 + 1];           // 议案编号 
  char            chVoteType;                 // 议案类型 字典[VOTE_TYPE]
...
struct MATRADEAPI CRspFsQry10308033Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            szMeetingSeq[10 + 1];       // 股东大会编码 
  char            szVoteId[10 + 1];           // 议案编号 
...
//-------------------------------10308059:网络投票产品信息查询--------------------------
struct MATRADEAPI CReqFsQry10308059Field
{
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szMeetingSeq[10 + 1];       // 股东大会编码 
  char            szVoteStkCode[8 + 1];       // 产品代码 
...
struct MATRADEAPI CRspFsQry10308059Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szMeetingSeq[10 + 1];       // 股东大会编码 
...
//-------------------------------10308051:港股通价差信息查询--------------------------
struct MATRADEAPI CReqFsQry10308051Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szPrice[21 + 1];            // 价格 
};

struct MATRADEAPI CRspFsQry10308051Field
{
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
//-------------------------------10308050:港股通汇率信息查询--------------------------
struct MATRADEAPI CReqFsQry10308050Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            chCurrency;                 // 货币代码 字典[CURRENCY]
};

struct MATRADEAPI CRspFsQry10308050Field
{
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            chCurrency;                 // 货币代码 字典[CURRENCY]
...
struct MATRADEAPI CReqFsQry10308061Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
};

struct MATRADEAPI CRspFsQry10308061Field
{
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CReqFsQry10308034Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308034Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
//-------------------------------10308035:港股通交易日历查询--------------------------
struct MATRADEAPI CReqFsQry10308035Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  int             iBgnDate;                   // 开始日期 
  int             iEndDate;                   // 结束日期 
...
struct MATRADEAPI CRspFsQry10308035Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
//-------------------------------10308047:港股通资金查询--------------------------
struct MATRADEAPI CReqFsQry10308047Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            chCurrency;                 // 货币代码 字典[CURRENCY]
...
struct MATRADEAPI CRspFsQry10308047Field
{
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
//-------------------------------10308036:大宗交易行情信息查询--------------------------
struct MATRADEAPI CReqFsQry10308036Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308036Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
//-------------------------------10308108:盘后行情查询--------------------------
struct MATRADEAPI CReqFsQry10308108Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
...
struct MATRADEAPI CRspFsQry10308108Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
...
struct MATRADEAPI CReqFsQry10308037Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
  char            szTrdacct[20 + 1];          // 证券账户 
...
struct MATRADEAPI CRspFsQry10308037Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
//-------------------------------10308067:股转分层信息查询--------------------------
struct MATRADEAPI CReqFsQry10308067Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308067Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
...
//-------------------------------10308109:股转询价确认信息查询--------------------------
struct MATRADEAPI CReqFsQry10308109Field
{
  char            szStkCode[8 + 1];           // 证券代码 
  char            szTrdacct[20 + 1];          // 证券账户 
...
struct MATRADEAPI CRspFsQry10308109Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            szStkCode[8 + 1];           // 证券代码 
  char            szTrdacct[20 + 1];          // 证券账户 
...
//-------------------------------10308110:股转发行业务信息查询--------------------------
struct MATRADEAPI CReqFsQry10308110Field
{
...
struct MATRADEAPI CRspFsQry10308110Field
{
  char            szQryPos[32 + 1];           // 定位串 
...
//-------------------------------10308038:股票质押合约总表查询--------------------------
struct MATRADEAPI CReqFsQry10308038Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFsQry10308038Field
{
  char            szQryPos[32 + 1];           // 定位串 
...
//-------------------------------10308039:股票质押合约明细查询--------------------------
struct MATRADEAPI CReqFsQry10308039Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szTrdacct[20 + 1];          // 交易账户 
  char            szGpzysno[32 + 1];          // 合约编号 
...
struct MATRADEAPI CRspFsQry10308039Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            szGpzysno[32 + 1];          // 合约编号 
  int             iItemno;                    // 合约序号 
...
struct MATRADEAPI CReqFsQry10308062Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szTrdacct[20 + 1];          // 交易账户 
  LONGLONG        llCuacctCode;               // 资产账户 
...
struct MATRADEAPI CRspFsQry10308062Field
{
  char            szReferenceAtm[21 + 1];     // 参考金额 
};

//-------------------------------10308063:股票质押股份额度信息查询--------------------------
struct MATRADEAPI CReqFsQry10308063Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szTrdacct[20 + 1];          // 交易账户 
  char            szStkCode[8 + 1];           // 证券代码 
...
struct MATRADEAPI CRspFsQry10308063Field
{
  char            szTrdacct[20 + 1];          // 交易账户 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
...
//-------------------------------10308076:股票质押标的证券查询--------------------------
struct MATRADEAPI CReqFsQry10308076Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 证券代码 
  char            szQryPos[32 + 1];           // 定位串 
...
struct MATRADEAPI CRspFsQry10308076Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CReqFsQry10308077Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szLoanerTrdacct[20 + 1];    // 出借人股东 
  char            szQryPos[32 + 1];           // 定位串 
...
struct MATRADEAPI CRspFsQry10308077Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CReqFsQry10308040Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFsQry10308040Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
  char            chStkex;                    // 交易市场 字典[STKEX]
...
struct MATRADEAPI CReqFsQry10308041Field
{
  char            szStkCode[8 + 1];           // 证券代码 
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308041Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szStkCode[8 + 1];           // 证券代码 
...
struct MATRADEAPI CReqFs10308613Field
{
...
struct MATRADEAPI CRspFs10308613Field
{
};

//-------------------------------10308072:上海协议回购非公开报价行情查询--------------------------
struct MATRADEAPI CReqFsQry10308072Field
{
...
struct MATRADEAPI CRspFsQry10308072Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
  char            szMatchedTime[8 + 1];       // 成交时间 
...
struct MATRADEAPI CReqFsQry10308073Field
{
  char            szQuoteRefId[10 + 1];       // 交易所报价请求编号 
  char            chMdUpdateAction;           // 行情更新类型 字典[MD_UPDATE_ACTION]
  char            chOrdType;                  // 报价申报类型 字典[ORD_TYPE]
...
struct MATRADEAPI CRspFsQry10308073Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
  char            szMatchedTime[8 + 1];       // 成交时间 
...
struct MATRADEAPI CReqFsQry10308075Field
{
...
struct MATRADEAPI CRspFsQry10308075Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
  int             iMatchDate;                 // 成交日期 
...
//-------------------------------10308078:上海协议回购合约查询--------------------------
struct MATRADEAPI CReqFsQry10308078Field
{
  char            szCompanyCode[3 + 1];       // 交易商代码 
  char            szOperCode[6 + 1];          // 交易员代码 
  LONGLONG        llCustCode;                 // 客户代码 
...
struct MATRADEAPI CRspFsQry10308078Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
  int             iSettDate;                  // 清算日期 
...
struct MATRADEAPI CReqFsQry10308086Field
{
  int             iStkBiz;                    // 证券业务 字典[STK_BIZ]
...
struct MATRADEAPI CRspFsQry10308086Field
{
  int             iStkBiz;                    // 证券业务 字典[STK_BIZ]
  int             iRepayOpeningDate;          // 初始交易日期 
  char            szInitTrdAmt[21 + 1];       // 初始交易金额 
...
//-------------------------------10308042:债券质押股份明细查询--------------------------
struct MATRADEAPI CReqFsQry10308042Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFsQry10308042Field
{
  char            szQryPos[32 + 1];           // 定位串 
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
...
struct MATRADEAPI CReqFsQry10308043Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFsQry10308043Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iRepchDate;                 // 到期日期 
  int             iTrdDate;                   // 交易日期 
...
struct MATRADEAPI CReqFs10308604Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  int             iTrdDate;                   // 交易日期 
...
struct MATRADEAPI CRspFs10308604Field
{
  int             iOrderBsn;                  // 委托批号 
  char            szOrderId[10 + 1];          // 合同序号 
  LONGLONG        llCuacctCode;               // 资产账户 
...
//-------------------------------10308605:ETF篮子委托--------------------------
struct MATRADEAPI CReqFs10308605Field
{
  LONGLONG        llCustCode;                 // 客户代码 
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CRspFs10308605Field
{
  int             iOrderBsn;                  // 委托批号 
  char            szOrderId[10 + 1];          // 合同序号 
  LONGLONG        llCuacctCode;               // 资产账户 
...
struct MATRADEAPI CReqFsQry10308057Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
...
struct MATRADEAPI CRspFsQry10308057Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
  int             iOrderDate;                 // 委托日期 
...
//-------------------------------10308064:ETF成分股持仓查询--------------------------
struct MATRADEAPI CReqFsQry10308064Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFsQry10308064Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szEtfCode[8 + 1];           // ETF代码 
...
//-------------------------------10308052:ETF信息查询--------------------------
struct MATRADEAPI CReqFsQry10308052Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szEtfCode[8 + 1];           // ETF代码 
  char            szQryPos[32 + 1];           // 定位串 
...
struct MATRADEAPI CRspFsQry10308052Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CReqFsQry10308044Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFsQry10308044Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CReqFsQry10308045Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szStkLofCode[8 + 1];        // LOF代码 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308045Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 证券交易所 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
//-------------------------------10308046:股权人员信息查询--------------------------
struct MATRADEAPI CReqFsQry10308046Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
  char            szTrdacct[20 + 1];          // 证券账户 
  char            szQryPos[32 + 1];           // 定位串 第一次填空
...
struct MATRADEAPI CRspFsQry10308046Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
//-------------------------------10308065:所得税策略信息维护--------------------------
struct MATRADEAPI CReqFsQry10308065Field
{
  int             iSno;                       // 流水号 
};

struct MATRADEAPI CRspFsQry10308065Field
{
  int             iSno;                       // 流水号 
...
struct MATRADEAPI CReqFsQry10308058Field
{
  char            szStkbd[32 + 1];            // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFsQry10308058Field
{
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szStkCode[8 + 1];           // 要约代码 
...
//-------------------------------10308070:上海减持股份额度查询--------------------------
struct MATRADEAPI CReqFsQry10308070Field
{
  char            szTrdacct[20 + 1];          // 交易账户 
  char            szStkCode[8 + 1];           // 证券代码 
};

struct MATRADEAPI CRspFsQry10308070Field
{
  int             iTrdDate;                   // 交易日期 
  char            szTrdacct[20 + 1];          // 交易账户 
  char            szStkCode[8 + 1];           // 证券代码 
...
//-------------------------------10308071:深圳减持股份额度查询--------------------------
struct MATRADEAPI CReqFsQry10308071Field
{
  char            szTrdacct[20 + 1];          // 交易账户 
  char            szStkCode[8 + 1];           // 证券代码 
  char            szStkpbu[8 + 1];            // 交易单元 
...
struct MATRADEAPI CRspFsQry10308071Field
{
  char            szTrdacct[20 + 1];          // 交易账户 
  char            szStkCode[8 + 1];           // 证券代码 
  char            szStkpbu[8 + 1];            // 交易单元 
...
//-------------------------------10308084:权证信息查询--------------------------
struct MATRADEAPI CReqFsQry10308084Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
...
struct MATRADEAPI CRspFsQry10308084Field
{
  char            chStkex;                    // 交易市场 
  char            szStkbd[2 + 1];             // 交易板块 
  char            szWrntCode[8 + 1];          // 权证代码 
...
//-------------------------------10308079:三方回购篮子信息查询--------------------------
struct MATRADEAPI CReqFsQry10308079Field
{
...
struct MATRADEAPI CRspFsQry10308079Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            szBasketId[8 + 1];          // 篮子编号 
...
//-------------------------------10308080:三方回购质押表查询--------------------------
struct MATRADEAPI CReqFsQry10308080Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szTrdacct[20 + 1];          // 交易账户 
...
struct MATRADEAPI CRspFsQry10308080Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iIntOrg;                    // 内部机构 
  LONGLONG        llCustCode;                 // 客户代码 
...
struct MATRADEAPI CReqFsQry10308081Field
{
  int             iTrdDate;                   // 交易日期 
  char            szOrderId[10 + 1];          // 合同序号 
...
struct MATRADEAPI CRspFsQry10308081Field
{
  int             iTrdDate;                   // 交易日期 
  char            szOpptStkpbu[8 + 1];        // 交易单元（对手） 
...
struct MATRADEAPI CReqFsQry10308082Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szTrdacct[20 + 1];          // 交易账户 
...
struct MATRADEAPI CRspFsQry10308082Field
{
  int             iTrdDate;                   // 交易日期 
  int             iMatchDate;                 // 成交日期 
  char            szSfcontractNo[32 + 1];     // 合约编号 
...
struct MATRADEAPI CReqFsQry10308083Field
{
  LONGLONG        llCuacctCode;               // 资产账户 
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szTrdacct[20 + 1];          // 交易账户 
...
struct MATRADEAPI CRspFsQry10308083Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iTrdDate;                   // 交易日期 
  int             iMatchDate;                 // 成交日期 
...
struct MATRADEAPI CReqFsQry10308104Field
{
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szTrdacct[20 + 1];          // 交易账户 
  char            szStkCode[8 + 1];           // 证券代码 
...
struct MATRADEAPI CRspFsQry10308104Field
{
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szTrdacct[20 + 1];          // 交易账户 
  char            szStkCode[8 + 1];           // 证券代码 
...
struct MATRADEAPI CReqFsQry10308105Field
{
  char            chStkex;                    // 交易市场 字典[STKEX]
...
struct MATRADEAPI CRspFsQry10308105Field
{
  char            chStkex;                    // 交易市场 字典[STKEX]
  char            szStkCodeI[8 + 1];          // 境内证券代码 
  char            szStkCodeO[8 + 1];          // 境外证券代码 
...
struct MATRADEAPI CReqFsQry10308106Field
{
...
struct MATRADEAPI CRspFsQry10308106Field
{
  char            szStkbd[2 + 1];             // 交易板块 字典[STKBD]
  char            szBjType[4 + 1];            // 报价类型 字典[INQUIRY_QUOTE_TYPE]
...
//-------------------------------10418001:历史成交查询--------------------------
struct MATRADEAPI CReqFsQry10418001Field
{
  LONGLONG        llCustCode;                 // 客户代码 客户代码及证券账户不能同时为空
...
struct MATRADEAPI CRspFsQry10418001Field
{
  char            szQryPos[32 + 1];           // 定位串 
  char            szMatchedTime[8 + 1];       // 成交时间 
...
//-------------------------------10418002:历史委托查询--------------------------
struct MATRADEAPI CReqFsQry10418002Field
{
  LONGLONG        llCuacctCode;               // 资金账号 资金账户及证券账户不能同时为空
  char            szFortuneCode[20 + 1];      // 财富账户 
  char            szTrdacct[20 + 1];          // 证券账户 资金账户及证券账户不能同时为空
...
struct MATRADEAPI CRspFsQry10418002Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iIntOrg;                    // 内部机构 
  int             iTrdDate;                   // 交易日期 
...
//-------------------------------10418003:历史交割单查询--------------------------
struct MATRADEAPI CReqFsQry10418003Field
{
...
struct MATRADEAPI CRspFsQry10418003Field
{
  char            szQryPos[32 + 1];           // 定位串 
  int             iSettDate;                  // 清算日期 

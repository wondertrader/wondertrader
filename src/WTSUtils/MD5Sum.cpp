...
{
	return Calculate((const unsigned char*)sSource.c_str(), sSource.size()*sizeof(char));
}

std::string MD5Sum::Calculate(const unsigned char* pachSource, uint32 nLen)
{
	MD5_CTX context;

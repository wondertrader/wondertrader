...
private:
	...
	typedef fastest_hashmap<std::string, RTKlineBlockPair>	RTKBlockFilesMap;
	...
	typedef fastest_hashmap<std::string, TickBlockPair>	TBlockFilesMap;
	...
	typedef fastest_hashmap<std::string, HisTBlockPair>	HisTickBlockMap;
	...
	typedef fastest_hashmap<std::string, HisTransBlockPair>	HisTransBlockMap;
	...
	typedef fastest_hashmap<std::string, HisOrdDtlBlockPair>	HisOrdDtlBlockMap;
	...
	typedef fastest_hashmap<std::string, HisOrdQueBlockPair>	HisOrdQueBlockMap;
...
private:
	...
	typedef fastest_hashmap<std::string, BarsList> BarsCache;

...
protected:
	std::string		m_strCommUser;  // 网关账户
	std::string		m_strCommPass;  // 网关密码

	std::string		m_strUser;  // 客户号
	std::string		m_strPass;  // 密码
	std::string		m_strNode;  // 站点信息

	std::string		m_strShGdh;                // 上海股东号
	std::string		m_strSzGdh;                // 深圳股东号
	std::string 	m_strShZjzh;               // 上海资金账号
	std::string 	m_strSzZjzh;               // 深圳资金账号
	std::string		m_strFDNO;  // 资金账号

...
#include "../API/AtpTradeApiMarginV4.1.1/include/atp_trade_api.h"
...
private:
	...
	inline WTSTradeInfo*	makeTradeRecord(const ATPRspCreditTradeERMsg &credit_trade_er);
...
private:
	...
	uint64_t		_sessionid;
	//int64_t			_sh_total_num;  // 总的订单数
	//int64_t			_sz_total_num;  // 深圳总的订单数

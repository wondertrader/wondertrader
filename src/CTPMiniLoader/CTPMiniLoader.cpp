...
#else
			MODULE_NAME = "./libthosttraderapi.so";
#endif
		}
...
#ifdef _WIN32
		MODULE_NAME = ini.readString("ctp", "module", "./thosttraderapi.dll");
#else
		MODULE_NAME = ini.readString("ctp", "module", "./libthosttraderapi.so");
#endif
	}
	else
	{
...
#	endif
	...
	std::string flowPath = fmtutil::format("./CTPMiniFlow/{}/{}/", BROKER_ID, INVESTOR_ID);

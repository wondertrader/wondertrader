...
struct WTSOrdQueStructOld
{
	...
	WTSOrdQueStructOld()
	{
		memset(this, 0, sizeof(WTSOrdQueStructOld));
	}
};
...
struct WTSOrdDtlStructOld
{
	...
	WTSOrdDtlStructOld()
	{
		memset(this, 0, sizeof(WTSOrdDtlStructOld));
	}
};
...
struct WTSTransStructOld
{
	...
	WTSTransStructOld()
	{
		memset(this, 0, sizeof(WTSTransStructOld));
	}
};
